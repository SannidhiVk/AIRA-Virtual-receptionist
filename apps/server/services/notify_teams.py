...
def _send_teams_notification_thread(
        ...
        "attachments": [
            {
                ...
                "content": {
                    ...
                    "body": [
                        {
                            "type": "TextBlock",
                            "text": f"🛎️ Visitor Arrival for {employee_name}",
                            "weight": "bolder",
                            "size": "Medium",
                        },
                        {
                        ...
                        {
                            "type": "TextBlock",
                            "text": "Please head to the front desk to meet your visitor.",
                            "wrap": True,
                        },
                    ],
                },
...
def send_teams_arrival(
    employee_name: str, visitor_name: str, visitor_type: str, purpose: str
):
    threading.Thread(
        target=_send_teams_notification_thread,
